...
export default {
    ...
    mounted() {
        if (
            ...
            !isNil(this.relatedResourceName)
        ) {
            this.pivot = true;

            if (
                this.relatedResourceId !== "" &&
                !isNil(this.relatedResourceId)
            ) {
    ...
    methods: {
        ...
        syncField() {
            ...
            Nova.request()
                ...
                .then((response) => {
                    ...
                    let emitChangesEvent =
                        !this.syncedFieldValueHasNotChanged();
        ...
        syncedFieldValueHasNotChanged() {
            ...
            return (
                !isNil(value) && value?.toString() === this.value?.toString()
            );
        },
    },
    ...
    computed: {
        ...
        encodedDependentFieldValues() {
            return btoa(
                escapeUnicode(JSON.stringify(this.dependentFieldValues))
            );
        },
